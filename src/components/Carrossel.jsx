...
export default function Carrossel({ap,showDetails,index}){
    return(
        <div onClick={() => showDetails(index)} className=" max-w-[240px] lg:mx-6 mx-1 my-1 bg-slate-100 rounded-2xl shadow-xl hover:card_hover transition relative">
            <img className="w-full rounded-t-2xl aspect-[16/14]" src={ap.img}></img>
            <a className=" duration-700 opacity-0 text-xs py-2 px-6 absolute bg-red-700 rounded-2xl text-white cursor-pointer top-[57%] right-1">VER DETALHES</a>
